...
const Footer = () => {
  return (
    <div className=" flex gap-5 w-full h-screen bg-[#F4F4F5] p-16">
      <div className="w-1/2 font-[founders] flex flex-col justify-between h-full ">
        <div className="heading">
          <h1 className="text-[8vw]  uppercase leading-none -mb-[2vw] tracking-tight ">
            Eye-
          </h1>
          <h1 className="text-[8vw] uppercase leading-none tracking-tight">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[8vw] font-[founders]  uppercase leading-none -mb-[3vw] tracking-tight ">
          Presentations
        </h1>
        <div className="dets font-['Neue_Montreal'] mt-10">
          <a className="block tex-xl font-light" href="#">
            Facebook
          </a>
          <a className="block tex-xl font-light" href="#">
            Instagram
